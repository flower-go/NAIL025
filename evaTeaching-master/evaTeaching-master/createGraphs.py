...
parser.add_argument('-l', '--labels', metavar='L', default=['New', 'Default'], type=str, nargs='+', help='Labels for graphs from files')
parser.add_argument('--logscale', metavar='S', choices=['x', 'y', 'both'], default = 'y', help='Set logarithmic axis (x, y, or both)')
parser.add_argument('-o', '--output', metavar='O', type=str, help='Name of the output file', default='f23_annealing.png')
parser.add_argument('-s','--scale', metavar='N', type=int,  help='Scaling for the numbers on x-axis', default=0.5)
